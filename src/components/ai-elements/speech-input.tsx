...
declare global {
  interface Window {
    SpeechRecognitionImpl: new () => SpeechRecognitionInstance;
    webkitSpeechRecognitionImpl: new () => SpeechRecognitionInstance;
  }
}

type SpeechInputMode = "speech-recognition" | "media-recorder" | "none";

const getSpeechRecognitionConstructor = (): (new () => SpeechRecognitionInstance) | undefined => {
