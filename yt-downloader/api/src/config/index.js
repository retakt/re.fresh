...
module.exports = {
  ...
  port: parseInt(process.env.PORT || process.env.YT_PORT, 10) || 3000,
  host: process.env.HOST || process.env.YT_HOST || '0.0.0.0',
  adminToken: process.env.ADMIN_TOKEN || process.env.YT_ADMIN_TOKEN,
  ...
  // Jobs
  jobTimeout: parseInt(process.env.JOB_TIMEOUT_MS, 10) || 300000,
