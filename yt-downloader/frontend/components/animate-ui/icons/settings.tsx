...
// Standalone version that accepts external controls (no IconWrapper needed)
export function SettingsIconControlled({
  size,
  controls,
  ...props
}: Omit<SettingsProps, 'animationControls'> & { controls: ReturnType<typeof useAnimation> }) {
